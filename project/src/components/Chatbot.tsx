    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-16 h-16 bg-purple-600 text-white rounded-full shadow-2xl hover:bg-pink-700 transition-all transform hover:scale-110 flex items-center justify-center z-50 animate-bounce"
        >
            ...
            {messages.length === 0 ? (
              <div className="text-center text-gray-500 py-12 px-4">
                ...
                <p className="text-lg font-bold text-gray-800 mb-2">
                  👋 Hello! I'm your LocalSewa AI Assistant
                </p>
                <p className="text-sm text-gray-600 mb-4">
                  I can help you find the perfect service provider in Kathmandu!
                </p>
                        ...
                        message.suggestions.length > 0 && (
                          <div className="mt-3 space-y-2">
                            ...
                            {message.suggestions.map((sug, idx) => (
                              <div
                                key={idx}
                                className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-2 border border-purple-100"
                              >
